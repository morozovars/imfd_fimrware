...
#include "app_os.h"                 //NOTE: for APP_TRACE_TASKS_CNT
#include "trace/dbgout.h"


//TODO: CONFIGURE MODULE:
/* MODULE PARAMETERS. */
#define APP_TRACE_TASKS_CNT     (THREADS_CNT)
#define APP_TRACE_PRINTF(...)         dbg_printf("<RTOS_trace> ");    \
                                      dbg_printf(__VA_ARGS__)
#define APP_TRACE_EXTERN_TIM    (0)
#if (APP_TRACE_EXTERN_TIM == 1)
# define APP_TRACE_TIMER_FREQ   (1000000u)
...
# define APP_TRACE_TIMER_FREQ   (1000000u) // Hz (not tested with others frequencies).
#endif
